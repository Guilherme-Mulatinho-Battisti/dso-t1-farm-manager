...
class TelaBase:
    def get_layout(self, titulo, opcoes: list, opcao_retorno):
        ...
        for opcao in opcoes:
            conteudo.append([sg.Push(), sg.Button(opcao, size=(50, 1), font=("Helvetica", 16)), sg.Push()])
        conteudo.append([sg.Push(),
             sg.Button(opcao_retorno, size=(50, 1), font=('Courier New', 15, 'bold'), button_color=('white', 'red')),
             sg.Push()])
